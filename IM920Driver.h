...
class IM920Driver {
  public:
    ...
    // get last line data
    void get_last_line(uint8_t buff[MAX_LINE_LENGTH]);
  ...
  private:
    ...
    uint8_t _line1[MAX_LINE_LENGTH];  // buffer of line data 1
    uint8_t _line2[MAX_LINE_LENGTH];  // buffer of line data 1
